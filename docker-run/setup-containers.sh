...
tmux new-session -d -s cont1 'docker run -it -v (pwd):/working_dir --cpus="4" --memory="1000m" --name=cont1 saytosid/myubuntu'
tmux new-session -d -s cont2 'docker run -it -v (pwd):/working_dir --cpus="4" --memory="1000m" --name=cont2 saytosid/myubuntu'
