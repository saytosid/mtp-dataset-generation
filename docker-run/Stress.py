...
class WordCount(Stresser):
    ...
    def doStress(self, intensity=1):
        ...
        print os.system('wc {}'.format(CreateFile().doStress(intensity)))
...
class Sort(Stresser):
    ...
    def doStress(self, intensity=1):
        '''Stresses the machine'''
        print os.system('sort {}'.format(CreateFile().doStress(intensity)))
...
class Grep(Stresser):
    ...
    def doStress(self, intensity=1):
        '''Stresses the machine'''
        print os.system('cat {} | grep 1'.format(CreateFile().doStress(intensity)))
...
class Concat(Stresser):
    ...
    def doStress(self, intensity=1):
        '''Stresses the machine'''
        print os.system('cat {}'.format(CreateFile().doStress(intensity)))
#################################################################
